          ...
          <div ng-controller="validate-answer">
            ...
            <md-tab ng-repeat="input in data" label="Question @{{$index+1}}">
              <md-content class="md-padding">
                ...
                <md-radio-group ng-disabled="isValid==true" flex ng-model="data[$index]">
                ...
                <md-button ng-click="validation(data[$index]))" class="md-raised md-primary btn-block">Check Answer</md-button>
              </md-content>
            </md-tab> 
